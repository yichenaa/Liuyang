		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>order Date</td>
					<%
						com.liuyang.model.Order o=(com.liuyang.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.liuyang.dao.UserDao userDao=new com.liuyang.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.liuyang.model.Payment.findByPaymentId(con,n);
						%>
